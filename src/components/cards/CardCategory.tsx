  ...
  return (
    <div className="col-span-1">
      <div className="card-box-shadow py-6 rounded-md mb-2 px-4">
        <div className="bg-brick-red-700 w-[140px] h-[140px] rounded-full flex items-center justify-center mx-auto mb-2">
          <img src={icon} alt={title} />
        </div>
        <p className="font-medium text-xl text-boulder-900 text-center mb-6">{title}</p>
